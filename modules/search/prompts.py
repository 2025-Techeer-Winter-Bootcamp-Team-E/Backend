...
{{
    ...
    "analysis_message": "사용자에게 건네는 친근한 분석/인사 메시지 (1-2문장)"
}}
...
- analysis_message: 사용자의 의도와 니즈를 파악했음을 보여주는 친절한 메시지. 예: "휴대성과 배터리를 중요하게 생각하시는군요! 대학생분들에게 인기 있는 가벼운 노트북들을 찾아봤습니다."
